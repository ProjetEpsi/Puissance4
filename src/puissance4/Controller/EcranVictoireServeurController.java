 ...
 *
 */
public class EcranVictoireServeurController implements Initializable {
    ...
    public void set(Scene scene, Joueur jGagnant, Joueur j1, Joueur j2, Socket socketduserveur, ServerSocket socketserver) {
        this.scene = scene;
        this.j1 = j1;
        this.j2 = j2;
