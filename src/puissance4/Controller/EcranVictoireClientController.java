 ...
 */
public class EcranVictoireClientController implements Initializable {
	...
	public void set(Scene scene, Joueur jGagnant, Joueur j1, Joueur j2, Socket socket, String ip) {
		this.scene = scene;
		this.j1 = j1;
		this.j2 = j2;
